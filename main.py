...
async def create_playlist_page(request: Request, user_id: int = Query(...)):
    return templates.TemplateResponse("create_playlist.html", {"request": request, "user_id": user_id})
...
async def create_playlist(
    ...
    logger.info(f"create_playlist called with playlist_name={playlist_name}, user_id={user_id}")
